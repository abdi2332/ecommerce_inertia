...
const Navbar = () => {
  ...
  const { cart, user, cartCount } = useCart();
  ...
  return (
    <nav className="bg-white dark:bg-gray-800 antialiased">
      ...
      <span className="absolute -top-0 left-4 inline-flex items-center justify-center px-1.5 py-0.5 text-[10px] font-bold leading-none text-white bg-red-600 rounded-full">
        {cartCount}
      </span>
    )}
