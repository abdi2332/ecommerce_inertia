      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            ...
            <p className="mt-4 text-gray-400 max-w-xs text-sm">
              Your one-stop destination for fashion, electronics, and lifestyle products. Quality guaranteed.
            </p>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-400 font-medium">
                <li className="mb-4">
                  <a href="#" className="hover:text-white transition-colors">Men's Fashion</a>
                </li>
                <li className="mb-4">
                  <a href="#" className="hover:text-white transition-colors">Women's Fashion</a>
                </li>
                <li className="mb-4">
                  <a href="#" className="hover:text-white transition-colors">Electronics</a>
                </li>
                <li>
                  <a href="#" className="hover:text-white transition-colors">Home & Garden</a>
                </li>
              </ul>
            </div>
            <div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-400 sm:text-center">
            © 2024 <a href="/" className="hover:text-white transition-colors">StyleHub™</a>. All Rights Reserved.
          </span>
